            ...
            <div class="container">
                ...
                <div class="collapse navbar-toggleable-md float-lg-right" id="mainNavbarCollapse">
                    <ul class="nav navbar-nav">
                        ...
                        <?php
                        if(empty($_SESSION["user_id"])) // nếu người dùng chưa đăng nhập
                        {
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Các Món Ăn Phổ Biến Trong Tháng</h2>
                <p class="lead">Cách dễ nhất để đặt món ăn yêu thích của bạn trong số 6 món hàng đầu này</p>
            </div>
            <div class="row">
                <?php 					
                    ...
                    echo '  <div class="col-xs-12 col-sm-6 col-md-4 food-item">
                            <div class="food-item-wrap">
                                ...
                                <div class="content">
                                    ...
                                    <div class="price-btn-block"> <span class="price">$'.$r['price'].'</span> <a href="dishes.php?res_id='.$r['rs_id'].'" class="btn theme-btn-dash pull-right">Đặt Ngay</a> </div>
                                </div>
                            </div>
                        </div>';
                }
                ...
                <div class="row how-it-works-solution">
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                        <div class="how-it-works-wrap">
                            <div class="step step-1">
                                ...
                                <h3>Chọn nhà hàng</h3>
                                <p>Chúng tôi đã có sẵn thực đơn từ nhiều nhà hàng giao hàng trực tuyến.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col3">
                        <div class="step step-3">
                            ...
                            <h3>Giao hàng hoặc lấy hàng</h3>
                            <p>Nhận thức ăn của bạn được giao đến! Và thưởng thức bữa ăn của bạn!</p>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="restaurant-wrap">
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-3 col-md-12 col-lg-3 text-xs-center">
                                            <a class="restaurant-logo" href="dishes.php?res_id=' . $rows['rs_id'] . '" > <img src="admin/Res_img/' . $rows['image'] . '" alt="Logo nhà hàng"> </a>
                                        </div>
