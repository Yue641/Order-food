                                            ...
                                            <?php
                                                ...
                                                {				
                                                    while($rows=mysqli_fetch_array($query))
                                                    {
                                                        ...
                                                        {
                                                            echo '<td> <button type="button" class="btn btn-info"><span class="fa fa-bars"  aria-hidden="true" ></span> Đang xử lý</button></td>';
                                                        }
                                                        if($status=="in process")
                                                        {
                                                            echo '<td> <button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin"  aria-hidden="true" ></span> Đang trên đường!</button></td>'; 
                                                        }
                                                        if($status=="closed")
                                                        {
                                                            echo '<td> <button type="button" class="btn btn-primary"><span  class="fa fa-check-circle" aria-hidden="true"></span> Đã giao</button></td>'; 
                                                        } 
                                                        if($status=="rejected")
                                                        {
                                                            echo '<td> <button type="button" class="btn btn-danger"> <i class="fa fa-close"></i> Đã hủy</button></td>'; 
                                                        } 
                                                        echo '<td>'.$rows['date'].'</td>';
                                                        echo '<td>
                                                            <a href="delete_orders.php?order_del='.$rows['o_id'].'" onclick="return confirm(\'Bạn có chắc không?\');" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
