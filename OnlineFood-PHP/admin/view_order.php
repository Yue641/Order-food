                                        ...
                                        <tbody>
                                           ...
                                           ?>
                                            <tr>
                                                ...
                                                <td><center>
                                                    <a href="javascript:void(0);" onClick="popUpWindow('order_update.php?form_id=<?php echo htmlentities($rows['o_id']);?>');" title="Cập nhật đơn hàng">
                                                        <button type="button" class="btn btn-primary">Cập nhật Trạng thái Đơn hàng</button>
                                                    </a>
                                                </center></td>
                                            </tr>    
                                            <tr>
                                                ...
                                                <td><center>
                                                    <a href="javascript:void(0);" onClick="popUpWindow('userprofile.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Xem thông tin người dùng">
                                                        <button type="button" class="btn btn-primary">Xem Chi tiết Người dùng</button>
                                                    </a>
                                                </center></td>
                                            </tr>    
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                { ?>
                                                <td><center><button type="button" class="btn btn-warning"><span class="fa fa-cog fa-spin" aria-hidden="true"></span> Đang trên đường!</button></center></td> 
                                                <?php
                                                }
                                                if($status=="closed")
                                                {
