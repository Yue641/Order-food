...
if(isset($_POST['submit']))          
{
    ...
    {	
        $error = '<div class="alert alert-danger alert-dismissible fade show">
                        ...
                        <strong>Tất cả các trường đều phải được điền đầy đủ!</strong>
                    </div>';
    }
    else
    {
        ...
        {        
            if($fsize >= 1000000)
            {
                $error = '<div class="alert alert-danger alert-dismissible fade show">
                            <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                            <strong>Kích thước ảnh tối đa là 1024kb!</strong> Hãy thử ảnh khác.
                          </div>';
            }
            else
            {
                $res_name = $_POST['res_name'];
                $sql = "INSERT INTO restaurant(c_id, title, email, phone, url, o_hr, c_hr, o_days, address, image) VALUES('".$_POST['c_name']."', '".$res_name."', '".$_POST['email']."', '".$_POST['phone']."', '".$_POST['url']."', '".$_POST['o_hr']."', '".$_POST['c_hr']."', '".$_POST['o_days']."', '".$_POST['address']."', '".$fnew."')";  // Lưu dữ liệu đã gửi vào cơ sở dữ liệu: hình ảnh
                mysqli_query($db, $sql); 
        ...
        elseif($extension == '')
        {
            $error = '<div class="alert alert-danger alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Vui lòng chọn hình ảnh</strong>
                    </div>';
        }
        else
        {
            $error = '<div class="alert alert-danger alert-dismissible fade show">
                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <strong>Định dạng không hợp lệ!</strong> Chỉ chấp nhận png, jpg, gif.
                    </div>';
        }               
    }
}
                            ...
                            <div class="form-body">
                                ...
                                <div class="row p-t-20">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_hr" class="form-control custom-select" data-placeholder="Chọn Giờ">
                                                    <option>--Chọn Giờ Mở--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="c_hr" class="form-control custom-select" data-placeholder="Chọn Giờ">
                                                    <option>--Chọn Giờ Đóng--</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select name="o_days" class="form-control custom-select" data-placeholder="Chọn Ngày">
                                                    ...
                                                    <option value="24hr-x7">24 giờ mỗi ngày</option>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group has-danger">
                                                ...
                                                <input type="file" name="file" id="lastName" class="form-control form-control-danger" placeholder="Chọn hình ảnh">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="c_name" class="form-control custom-select" data-placeholder="Chọn Danh mục">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <div class="form-group">
                                                <textarea name="address" type="text" style="height:100px;" class="form-control" placeholder="Nhập địa chỉ nhà hàng"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
